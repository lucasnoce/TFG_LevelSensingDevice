...
#include "MyDriversInc/global_var.h"
...
/* USER CODE BEGIN PV */
static LSD_MCU_PERIPH_HANDLES_T hmcu_peripherals;
/* USER CODE END PV */
...
//	HAL_UART_Transmit( &huart1, modem_tx, 5, 1000 );
//	HAL_UART_Receive( &huart1, modem_rx, 64, 1000 );
//
//	CDC_Transmit_FS( modem_rx, strlen( (char *) modem_rx ) );
////	ret = ajsr04m_read_tof_blocking( 10000 );
//	HAL_Delay( 1000 );
  }
  /* USER CODE END 3 */
}
