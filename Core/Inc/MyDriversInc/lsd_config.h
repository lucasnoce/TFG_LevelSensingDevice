...
#define LSD_PERIPH_USED_AHT20		TRUE
#define LSD_PERIPH_USED_AJSR04M		TRUE
#define LSD_PERIPH_USED_LEDS		TRUE
#define LSD_PERIPH_USED_LE910R1BR	TRUE
#define LSD_PERIPH_USED_VL53L0CX	TRUE
#define LSD_PERIPH_USED_USB			FALSE

/*
 * Timers and channels
 */

#define LSD_UART_FTDI				( 2 - 1 )
#define LSD_UART_MODEM				( 1 - 1 )
